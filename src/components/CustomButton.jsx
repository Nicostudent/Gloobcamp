const CustomButton = ({ children, purple, className, text, disabled, icon, arialLabelProp, ...props }) => {
  const baseStyles = "h-12 text-center text-base font-semibold leading-6 rounded-md flex items-center";
  ...
  return (
    <button
      aria-label={arialLabelProp || text}
