const CustomButton = ({ children, purple, className, text, disabled, icon, ...props }) => {
  const baseStyles = "w-full h-12 text-center text-base font-semibold leading-6 rounded-md flex items-center";
